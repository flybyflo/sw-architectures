...
This table collects **24 typical architecture questions**. In accordance with the acceptance criteria, **16 core questions are marked for final evaluation** (`Evaluation: Yes`).
...
| **Q06** | What are the main components of a scalable web architecture (load balancers, caching, databases, queues) and how do they manage concurrent loads? | High-Level Architectural Design | `wiki/patterns/`, `raw_sources/aosa/` | **Yes** |
| **Q07** | What are the most common architectural styles and patterns (client-server, layered, pub-sub, event sourcing) and what specific problems do they solve? | Architectural Styles & Patterns | `wiki/patterns/`, `raw_sources/extra_sources/` | **Yes** |
...
| **Q13** | What distributed reliability mechanisms (retries, circuit breakers, bulkheads, rate limiters) protect systems from cascading failures, and what are their trade-offs? | Quality Attributes (Reliability) | `wiki/quality-attributes/`, `raw_sources/extra_sources/` | **Yes** |
| **Q14** | Which quality attributes (performance, scalability, availability) are prioritized in the design of nginx, and what architectural decisions support them? | Quality Attributes (Performance) | `wiki/quality-attributes/`, `raw_sources/aosa/` | **Yes** |
| **Q15** | How do architectural decisions in MediaWiki impact the trade-offs between performance, modifiability, and security? | Quality Attributes (Trade-offs) | `wiki/quality-attributes/`, `raw_sources/aosa/` | **Yes** |
| **Q16** | Compare how Eclipse, Jitsi, and MediaWiki achieve modularity and extensibility. What are the key differences in their plugin or extension models? | Cross-Project Comparison | `wiki/projects/`, `raw_sources/aosa/` | **Yes** |
| **Q17** | Compare nginx and Hadoop HDFS in terms of how they handle scalability. How do their architectural styles differ to support their scaling goals? | Cross-Project Comparison | `wiki/projects/`, `raw_sources/aosa/` | **Yes** |
...
| **Q19** | What are the architectural trade-offs between routing client requests through an API Gateway versus having clients access microservices directly? | Cross-Project Comparison | `wiki/patterns/`, `raw_sources/extra_sources/` | No |
| **Q20** | Which projects in the repository utilize a plugin-based or modular architecture (e.g., Eclipse, MediaWiki, Moodle), and how does this affect modifiability? | Project-Specific Questions | `wiki/projects/`, `raw_sources/aosa/` | No |
| **Q21** | How does Git ensure data integrity inside its object database, and what role do cryptographic hashes play in preventing state corruption? | Project-Specific Questions | `wiki/projects/`, `raw_sources/aosa/` | No |
| **Q22** | Which questions about system components and quality attributes are currently unanswerable from the Wiki pages due to missing content in `wiki/components/` and `wiki/quality-attributes/`? | Questions Exposing Coverage Gaps | `wiki/components/`, `wiki/quality-attributes/` | **Yes** |
| **Q23** | Which planned project pages are currently missing from `wiki/projects/` and what key questions should be prioritized to bootstrap their documentation? | Questions Exposing Coverage Gaps | `wiki/projects/` | **Yes** |
| **Q24** | What shared architectural components and patterns (such as caching, messaging, or gateways) are recurring across different open-source projects and extra sources in this repository? | Cross-Project Comparison | `wiki/components/`, `raw_sources/extra_sources/` | No |
...
* **Target Source File(s)**: [nginx.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/nginx.md)
* **Expected Wiki Page**: `wiki/projects/nginx.md`
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [git.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/git.md)
* **Expected Wiki Page**: `wiki/projects/git.md`
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [mediawiki.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/mediawiki.md)
* **Expected Wiki Page**: `wiki/projects/mediawiki.md`
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [hadoop-hdfs.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/hadoop-hdfs.md)
* **Expected Wiki Page**: `wiki/projects/hadoop-hdfs.md`
* **Evaluation Core**: **Yes**
...
* **Category**: Components & Interfaces / Project-Specific Questions
* **Target Source File(s)**: [llvm.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/llvm.md)
* **Expected Wiki Page**: `wiki/projects/llvm.md`
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [scalable-web-architecture-distributed-systems.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/scalable-web-architecture-distributed-systems.md)
* **Expected Wiki Page**: `wiki/patterns/` (distributed systems general architecture)
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [bytebytego-architecture-patterns.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-architecture-patterns.md)
* **Expected Wiki Page**: `wiki/patterns/`
* **Evaluation Core**: **Yes**
...
* **Category**: Architectural Styles & Patterns
* **Target Source File(s)**: [bytebytego-api-gateway.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-api-gateway.md)
...
* **Category**: Architectural Styles & Patterns
* **Target Source File(s)**: [bytebytego-messaging-patterns.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-messaging-patterns.md)
...
* **Target Source File(s)**: [bytebytego-caching-strategies.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-caching-strategies.md)
* **Expected Wiki Page**: `wiki/patterns/caching-strategies.md`
* **Evaluation Core**: **Yes**
...
* **Category**: Data & State Management
* **Target Source File(s)**: [bytebytego-database-sharding.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-database-sharding.md)
...
* **Target Source File(s)**: [bytebytego-distributed-reliability.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-distributed-reliability.md)
* **Expected Wiki Page**: `wiki/quality-attributes/reliability.md`
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [nginx.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/nginx.md)
* **Expected Wiki Page**: `wiki/quality-attributes/performance.md`
* **Evaluation Core**: **Yes**
...
* **Category**: Quality Attributes
* **Target Source File(s)**: [mediawiki.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/mediawiki.md)
* **Expected Wiki Page**: `wiki/quality-attributes/tradeoffs.md`
* **Evaluation Core**: **Yes**
...
* **Target Source File(s)**: [eclipse.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/eclipse.md), [jitsi.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/jitsi.md), [mediawiki.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/mediawiki.md)
* **Expected Wiki Page**: `wiki/projects/`, `wiki/patterns/modular-extensibility.md`
* **Evaluation Core**: **Yes**
...
* **Category**: Cross-Project Comparison Questions
* **Target Source File(s)**: [nginx.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/nginx.md), [hadoop-hdfs.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/hadoop-hdfs.md)
* **Expected Wiki Page**: `wiki/quality-attributes/scalability.md`
* **Evaluation Core**: **Yes**
...
* **Category**: Cross-Project Comparison Questions
* **Target Source File(s)**: [git.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/git.md), [mercurial.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/mercurial.md)
* **Expected Wiki Page**: `wiki/projects/`
* **Evaluation Core**: No
...
* **Category**: Cross-Project Comparison Questions
* **Target Source File(s)**: [bytebytego-api-gateway.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/extra_sources/bytebytego-api-gateway.md)
* **Expected Wiki Page**: `wiki/patterns/api-gateway.md`
* **Evaluation Core**: No
...
* **Target Source File(s)**: [eclipse.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/eclipse.md), [mediawiki.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/mediawiki.md), [moodle.md](file:///Users/kacperchojnacki/workspace/sw-architectures/raw_sources/aosa/moodle.md)
* **Expected Wiki Page**: `wiki/patterns/`
* **Evaluation Core**: No
...
* **Target Source File(s)**: [AGENTS.md](file:///Users/kacperchojnacki/workspace/sw-architectures/AGENTS.md), `wiki/components/`, `wiki/quality-attributes/`
* **Expected Wiki Page**: N/A (Meta-query)
* **Evaluation Core**: **Yes**
* **Rationale**: Designed to expose empty folders. Since `wiki/components/` and `wiki/quality-attributes/` only contain `.gitkeep` files, an honest agent answering this must point out that the wiki has zero synthesized articles for these areas, falling back to raw notes.
* **Key Indicators**: Presence of `.gitkeep`, lack of index linking, fallback warning to raw notes.

#### Q23: Missing Project Syntheses
* **Category**: Questions that expose missing or weak wiki coverage
* **Target Source File(s)**: [wiki/index.md](file:///Users/kacperchojnacki/workspace/sw-architectures/wiki/index.md), `wiki/projects/`
* **Expected Wiki Page**: N/A (Meta-query)
* **Evaluation Core**: **Yes**
* **Rationale**: Tests if the knowledge base can cross-reference the planned projects list in `wiki/index.md` (which plans Git, nginx, MediaWiki, HDFS, and LLVM pages) against the actually existing files under `wiki/projects/` (which are currently empty).
* **Key Indicators**: Under-synthesis warnings, empty `wiki/projects/` folder.
...
* **Expected Wiki Page**: `wiki/components/`
* **Evaluation Core**: No
...
1. **Source Fidelity**: Ensure the answering agent explicitly cites files from `wiki/` (primary) or `raw_sources/` (fallback) as mandated by [AGENTS.md](file:///Users/kacperchojnacki/workspace/sw-architectures/AGENTS.md).
...
4. **Gap Identification**: For **Q22** and **Q23**, the system must acknowledge that the wiki layer is unpopulated, demonstrating truthfulness instead of hallucinating synthesized content.
