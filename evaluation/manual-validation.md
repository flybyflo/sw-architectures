...
| **Q03** | MediaWiki Patterns & Caching | Architectural Styles & Patterns | index | `wiki/projects/mediawiki.md`, `wiki/components/plugin-system.md` | 5/5 | 5/5 | Highly complete details on Varnish/Vikitext/Memcached caching hierarchy. | No |
